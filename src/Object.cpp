...
//        vertBuffer[t2].norm = vertBuffer[t2].norm + normBuffer[n2];
//        vertBuffer[t3].norm = vertBuffer[t3].norm + normBuffer[n3];
//
//    }
//
//    len = vertBuffer.size();
...
////        vertexes
////            v[0] = Vec2(600,150,-12,.5);
////            v[2] = Vec2(600,300,-14,.3);
////            v[1] = Vec2(300,200,-10,.9);
